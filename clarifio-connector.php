...
$icon_base64 = 'data:image/svg+xml;base64,';
    add_menu_page(
        'Clarif.io Dashboard', 
        'Clarif.io', 
        'manage_woocommerce', 
            ...
            <div style="background: #fff; padding: 20px; border-left: 4px solid #2563eb; box-shadow: 0 1px 3px rgba(0,0,0,.05); margin-bottom: 20px; display: flex; align-items: center; justify-content: space-between;">
                <div>
                    <h1 style="margin: 0; color: #1e293b; font-size: 24px; display: flex; align-items: center;">
                        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><title>clarifio-favicon</title><rect x="18.455" y="17.556" width="474.15" height="474.15" rx="12" fill="#0f172a"/><path d="M308.518,250.586a150.758,150.758,0,0,1,4.585,38.022q0,26.391-7.631,47.864t-23.287,34.154q-15.663,12.681-39.2,12.681t-38.937-12.681q-15.4-12.672-23.03-34.154t-7.632-47.864q0-26.906,7.632-48.254t23.03-34.023q15.386-12.672,38.937-12.678c.031,0,.061,0,.092,0l9.32-54.335c-3.094-.158-6.222-.262-9.412-.262q-42.169,0-73.221,18.629t-47.995,52.4q-16.955,33.762-16.946,78.786,0,44.5,16.946,78.009t47.995,52.265Q200.81,437.9,242.982,437.9q42.438,0,73.482-18.755t48-52.265q16.938-33.509,16.946-78.009,0-39.192-12.853-69.848Z" fill="#fff"/><path d="M310.921,71.363,286.976,206.52l119.263-60.7C394.1,102.133,358.86,73.709,310.921,71.363Z" fill="#059669"/></svg> 
                        Clarif.io Workspace
                    </h1>
                    <p style="margin: 5px 0 0 0; color: #64748b; font-size: 14px;">Η καθημερινή σας οικονομική πυξίδα για το e-commerce.</p>
                </div>
                <div>
                    <a href="https://app.clarif.io" target="_blank" class="button" style="display: flex; align-items: center; gap: 5px;">
